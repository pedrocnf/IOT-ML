...
const port = new SerialPort('/dev/cu.wchusbserial1410'); //Connect serial port to port COM3. Because my Arduino Board is connected on port COM3. See yours on Arduino IDE -> Tools -> Port
